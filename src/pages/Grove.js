  ...
  return (
    <>
      ...
      <p>
        ...
        <Sub c={lookTree}>tree taller than the rest</Sub>. Otherwise, the only
        notable feature is the path, which spreads from one road into many. The
        path splits in four directions:
      </p>
      <ul>
        <li>
